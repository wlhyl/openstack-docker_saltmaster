...
{{ pillar['docker']['registry'] }}/lzh/neutron-plugin-openvswitch-agent:
  docker.pulled:
    - name: {{ pillar['docker']['registry'] }}/lzh/neutron-plugin-openvswitch-agent-dvr
    - tag: {{ openstack_version }}
    - insecure_registry: True

neutron-plugin-openvswitch-agent_docker:
  docker.running:
    - name: neutron-plugin-openvswitch-agent-dvr
    - image: {{ pillar['docker']['registry'] }}/lzh/neutron-plugin-openvswitch-agent-dvr:{{ openstack_version }}
    - environment:
