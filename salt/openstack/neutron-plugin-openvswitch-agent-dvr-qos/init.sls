...
{{ pillar['docker']['registry'] }}/lzh/neutron-plugin-openvswitch-agent:
  docker.pulled:
    - name: {{ pillar['docker']['registry'] }}/lzh/neutron-plugin-openvswitch-agent-dvr-qos
    - tag: {{ openstack_version }}
    - insecure_registry: True

neutron-plugin-openvswitch-agent_docker:
  docker.running:
    - name: neutron-plugin-openvswitch-agent-dvr-qos
    - image: {{ pillar['docker']['registry'] }}/lzh/neutron-plugin-openvswitch-agent-dvr-qos:{{ openstack_version }}
    - environment:
